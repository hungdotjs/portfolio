...
function Background() {
  ...
  const [giantColor] = useState('0,0,0');
  const [cometColor] = useState('0,0,0');
  const [starColor] = useState('0,0,0');
  ...
  useEffect(() => {
    ...
    function windowResizeHandler() {
      ...
      canva.setAttribute('height', height - 48);
    }
  }, [speedCoeff, cometColor, giantColor, starColor, starDensity]);

  return <canvas ref={canva} id="universe"></canvas>;
}
